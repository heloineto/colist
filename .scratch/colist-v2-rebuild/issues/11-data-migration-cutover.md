...
- 2026-08-31: cutover done (47 users / 43 lists / 899 items). Step (5) amended — the Vercel project is **not** deleted: `colist.vercel.app` serves a permanent 308 → `https://colist.heloineto.com` via a redirect-only `vercel.json` (Git integration disconnected, no builds). "Old URL dies — no redirect" is superseded. Supabase pause after the soak (≥ 2026-09-07), delete ≥ 2026-10-07 — tracked in [P5 spec](../../colist-v2-p5-cutover/spec.md).
