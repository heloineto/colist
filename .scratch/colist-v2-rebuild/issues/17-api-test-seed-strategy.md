...
- 2026-08-30 (from [AWS and Terraform architecture](12-aws-terraform-architecture.md)): API config is `DATABASE_URL` only (no `POSTGRES_*` pieces) — `docker-compose.test.yml` / globalSetup should set the same var.
